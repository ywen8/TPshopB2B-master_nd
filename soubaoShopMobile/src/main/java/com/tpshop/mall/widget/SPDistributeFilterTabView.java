...
public class SPDistributeFilterTabView extends FrameLayout implements View.OnClickListener {
    ...
    public SPDistributeFilterTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.spdistribute_list_tab_view, this);
        ...
        newlyout = view.findViewById(R.id.sort_new_lyout);
        newTxt = (TextView) view.findViewById(R.id.sort_new_txt);
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.sort_new_lyout) {
    ...
    private void refreshSortViewState(ProductSortType sortType) {
        ...
        newTxt.setTextColor(getResources().getColor(R.color.sort_normal_text_color));
        ...
        switch (sortType) {
            case composite:
                ...
                break;
            case news:
                newTxt.setTextColor(getResources().getColor(R.color.sort_selected_text_color));
                break;
            case salenum:
