...
public class BadgeView extends TextView {
    ...
    /**
     * create a new BadgeView instance attached to a target tab at a given index
     */
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.textSizeSmall));
